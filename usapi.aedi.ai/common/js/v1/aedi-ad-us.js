  ...
  Aedi.prototype = {
    initialize: function (t) {
      (this.ai_version = "v1"),
        ...
        (this.pass = new Image()),
        (this.ld = new Image()),
        (this.mask.src = "https://uscdn2.aedi.ai/img/cover/mask.png"),
        (this.over.src = "https://uscdn2.aedi.ai/img/cover/over.png"),
        (this.over_amber.src =
          "https://uscdn2.aedi.ai/img/cover/over_amber.png"),
        (this.over_aedi.src = "https://uscdn2.aedi.ai/img/cover/over_aedi.png"),
        (this.over_2x.src = "https://uscdn2.aedi.ai/img/cover/over_2x.png"),
        (this.ad.src = "https://uscdn2.aedi.ai/img/cover/ad_kr3.png"),
        //"kr" == this.nation ? this.ad.src = "https://uscdn2.aedi.ai/img/cover/ad_kr3.png" : this.ad.src = "https://uscdn2.aedi.ai/img/cover/ad_cn.png",
        (this.is_pv = false);
      this.seen = new Array();
      document.createElement("img").src =
        "https://usimp.aedi.ai/loc/?v=" + encodeURIComponent(location.href);
    },
    getBaseURL: function () {
    ...
    imgCrop: function (t, e, i, n, o, r, a, s) {
      ...
      if ("ai" == o) {
        ...
        u.scale(d, d),
          ...
          (_[0].src = "https://uscdn2.aedi.ai/img/paper2_1.png"),
          (_[1] = new Image()),
          (_[1].src = "https://uscdn2.aedi.ai/img/paper2_2.png"),
          (_[2] = new Image()),
          (_[2].src = "https://uscdn2.aedi.ai/img/paper2_3.png"),
          (_[3] = new Image()),
          (_[3].src = "https://uscdn2.aedi.ai/img/paper2_4.png");
        var k = 0;
        c.onload = function () {
        ...
        (_[0] = new Image()),
          ...
          (_[2] = new Image()),
          "pc" == s
            ? ((_[0].src = "https://uscdn2.aedi.ai/img/01-ad-fold-165.png"),
              (_[1].src = "https://uscdn2.aedi.ai/img/02-ad-fold-165.png"),
              (_[2].src = "https://uscdn2.aedi.ai/img/03-ad-fold-165.png"))
            : ((_[0].src = "https://uscdn2.aedi.ai/img/01-ad-fold-132.png"),
              (_[1].src = "https://uscdn2.aedi.ai/img/02-ad-fold-132.png"),
              (_[2].src = "https://uscdn2.aedi.ai/img/03-ad-fold-132.png")),
          (c.onload = function () {
            for (var t = 0; t < _.length; t++)
              _[t].onload = function () {
                if (++k == _.length) {
    ...
    adCreate: function (api_key, img, attr, date, img_cap, cap = null) {
      ...
      if (s == null && img.getAttribute("data-src"))
          ...
          if (
            ...
            img.removeAttribute("data-loaded"),
              ...
              (self.interval[r] = setInterval(function () {
                ...
                var slideContainer = img.closest('.tnt-slider');
                if(slideContainer){
                  var imgRect = img.getBoundingClientRect();
                  var viewportRect = slideContainer.getBoundingClientRect();

                  // 이미지가 실제로 보이는 영역에 있는지 체크 (가로만, 슬라이더는 좌우 이동)
                  isImageVisible = (imgRect.left >= viewportRect.left && imgRect.right <= viewportRect.right) &&
                                    imgRect.width > 0 && imgRect.height > 0;
                }
                
                if (img.complete && self.isVisible(img) && isImageVisible) {
                  if (
                  ...
                  // 이미지가 안 보이면 캔버스와 ad_link 숨김
                  f.style.display = "none";
                  c.style.display = "none";
                  self.canvas[r].style.display = "none";
                  self.ad_link[r].style.display = "none";
                }
              }, 100)),
              loadPrequired(),
      ...
      function showAD(url) {
        ...
        return (
          loadJSONP(url, function (responseJson) {
            ...
            //       "click_url": "https://cl.aedi.ai/v1/link?au=5524&fp=ec8a7e55716b6b6b98e22c9847949aa1&ik=1907964325.1721701766&k=%3DkUQ6AjOxATN1ojULVkVJxkOwATM6clULpzN3gjMykDMwA1X0EzMyoDNyUTN6ATY5MmYiNDZlhjZmJWNiRGMxczNlRjY4cjZmFWZkJWZ6MTO0ojNyEzM&t=3cDOyITOwADcts2YhxmYtIXZ6FGbi1CZlR3chVmci1SZsdmbpNXLpxWYtF2atEWby9mbGJTJuVWbvdnRyUybrZkMlI3aGJTJt92YuE2clJXZoRXet5yd3dnRyUiRyUSQzUycwRHdo1DbyV3P4cjNyYDNzETLzQjM2QDMxATMts2Ypx2YvQXZu5yd2x2biBHZuc3d39yL6MHc0RHa&loc=aHR0cHM6Ly9mYW5uc3Rhci50Zi5jby5rci9mbm5ld3MvcmVhZC8xMTQ5ODAjX1BB",
            //       "abf_info": {
            //           "class": "Outer",
      ...
      function aedi_secret_box(
        ...
        aedi_logoImg.src = "https://uscdn2.aedi.ai/common/img/aediAI_blue.png";
